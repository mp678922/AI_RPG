...
以Json形式為基礎而撰寫的RPG腳本。
筆者是以「VSCode程式編輯器」管理多個規則文件來統合整個腳本。並由自行撰寫的C#程式碼將多份規則文件統一成最終規則書。

但請不要被這個撰寫環境嚇到，這僅是筆者的工具，無論什麼工具都可以，這其實沒有門檻，只要寫成一個能表達遊戲腳本的檔案傳給AI即可。
...
**重要：使用Json結構並非必備事項，您可以嘗試任何表達方式與AI傳達腳本。**
